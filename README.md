...
Check an org file for markup delimiters (`$`, `=`, `~`, `+`) touching CJK characters
...
Tests cover:
- Detection of all delimiter types (`$`, `=`, `~`, `+`) touching CJK
...
Org-mode delimiters (`$`, `=`, `~`, `+`) require whitespace or ASCII punctuation as
boundaries. CJK characters (U+3000–U+303F, U+4E00–U+9FFF, U+FF00–U+FFEF) are NOT
valid boundaries:
